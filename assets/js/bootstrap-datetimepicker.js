...
!function ($) {
    ...
    var Datetimepicker = function (element, options) {
        ...
        this.setDatesDisabled(options.datesDisabled || this.element.data('date-days-disabled'));
    ...
    Datetimepicker.prototype = {
        ...
        setDatesDisabled: function (datesDisabled) {
            ...
            if (!$.isArray(this.datesDisabled)) {
                var datesDisabled = [];
                datesDisabled.push(DPGlobal.parseDate(this.datesDisabled, format, language, formatType));
                this.datesDisabled = datesDisabled;
            }
        ...
        fill: function () {
            ...
            while (prevMonth.valueOf() < nextMonth) {
                ...
                if ((prevMonth.valueOf() + 86400000) <= this.startDate || prevMonth.valueOf() > this.endDate ||
                    ...
                    (this.datesDisabled.length > 0 && $.grep(this.datesDisabled, function(d){return isUTCEquals(prevMonth, d); }).length > 0)) {
                    clsName += ' disabled';
                }
